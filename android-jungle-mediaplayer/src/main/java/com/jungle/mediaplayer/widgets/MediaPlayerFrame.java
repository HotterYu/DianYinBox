...
import com.jungle.mediaplayer.widgets.control.MusicPlayViewControl;
...
public abstract class MediaPlayerFrame extends FrameLayout
    ...
    protected OnCallBackListener mOnCallBackListener = null;
    public interface OnCallBackListener
    {
        void onDevInfoShow(boolean show);
        void onLogoViewClick();
        void onCloseClick();
    }

    public void setOnCallBackListener(OnCallBackListener mOnMediaTypeListener)
    {
        this.mOnCallBackListener = mOnMediaTypeListener;
    }
    ...
    protected MusicPlayViewControl mMusicPlayViewControl;
    ...
    private void initView() {
        ...
        mMusicPlayViewControl = (MusicPlayViewControl)findViewById(R.id.player_music_play_control);
        ...
        mBottomControl.setOperationHelper(new PlayerBottomControl.OperationHelper() {
            ...
            @Override
            public void switchRoation() {
                degreee = degreee + 90;
                if(degreee >= 360)
                    degreee = 0;
                mTextureView.setRotation(degreee);
            }
    ...
    protected void scheduleHideTitleBar() {
        unScheduleHideTitleBar();
        postDelayed(mHideTitleBarRunnable, 10*1000);
    }
