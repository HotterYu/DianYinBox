    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.cofirm_button:{
                wifiPwd = password_edit.getText().toString();
                WifiConfiguration wifiConfiguration  = WifiSupport.isExsits(text_nameString,getContext());
                if(wifiConfiguration == null){
                    wifiConfiguration =  WifiSupport.createWifiConfig(text_nameString,wifiPwd,WifiSupport.getWifiCipher(capabilities));
