...
public class ShellUtils 
{
	...
	public static void setCode(String code)
	{
		try 
		{
			...
			String[] commands = new String[] { "cd /sys/class/unifykeys", "echo 1 > attach","echo usid > name","echo " + code+ " > write"};
			CommandResult result = execCommand(commands, true);
	...
	private static String filterCode(String code)
	{
		if(code.length() > 4)
	...
	*/
	...
	{
		return execCommand(commands.toArray(new String[] {}).toString(), isRoot, true);
	}
	...
	*/
	...
	{
		return execCommand(commands == null ? null : commands.toArray(new String[] {}).toString(), isRoot, isNeedResultMsg);
	}
