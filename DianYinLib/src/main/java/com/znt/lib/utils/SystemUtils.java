...
public class SystemUtils
{
	...
	* @throws
	...
	private static PackageInfo getPkgInfo(Context activity)
	{
		// 获取packagemanager的实�?
		PackageManager packageManager = activity.getPackageManager();
		// getPackageName()是你当前类的包名�?0代表是获取版本信�?
	...
	public static PackageInfo getApkFileInfor(Context activity, String filePath)
	{
		PackageManager packageManager = activity.getPackageManager();  
  ...
  //版本�?
    ...
    public static int getVersionCode(Context context) {
  	...
  	public static int getCurrentVolume(Context activity)
	{
	...
	public static String getOsVersion()
	{
		...
		String osVersion = "Product Model: " + android.os.Build.MODEL + ","
