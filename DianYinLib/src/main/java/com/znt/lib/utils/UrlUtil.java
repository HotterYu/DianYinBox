...
public class UrlUtil {
    ...
    public static boolean isEncoded(String content, String charset) {
        ...
        Log.d("wlf", "isEncoded锛宑heck content锛�" + content);
    ...
    /*public static String getEncodedUrl(String url, String charset, boolean useFragment, boolean blankAsPlus) {
        ...
        Log.d("wlf", "getEncodedUrl锛�--------------------");

        Log.d("wlf", "getEncodedUrl锛屽噯澶囩紪鐮乁RL锛寀rl锛�" + url);
        ...
        try {
            ...
            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛寀nEncodeUrl锛�" + unEncodeUrl);

            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etProtocol锛�" + unEncodeUrl.getProtocol());

            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etHost锛�" + unEncodeUrl.getHost());
            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etUserInfo锛�" + unEncodeUrl.getUserInfo());

            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etPort锛�" + unEncodeUrl.getPort());

            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etFile锛�" + unEncodeUrl.getFile());
            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etPath锛�" + unEncodeUrl.getPath());
            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etQuery锛�" + unEncodeUrl.getQuery());
            Log.d("wlf", "getEncodedUrl锛屽紑濮嬬紪鐮乁RL锛実etRef锛�" + unEncodeUrl.getRef());
        ...
        Log.e("wlf", "getEncodedUrl锛岀紪鐮佸悗URL锛宔ncodedUrl锛�" + encodedUrl);
